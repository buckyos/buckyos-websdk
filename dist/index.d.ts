...
export declare const buckyos: {
    ...
    loginByPassword: (username: string, password: string, target?: import("./verify-hub-client").AuthTarget | undefined) => Promise<import("./account").AccountInfo | null>;
    ...
    getWorkflowClient: () => import("./workflow_client").WorkflowClient;
...
export declare const loginByPassword: (username: string, password: string, target?: import("./verify-hub-client").AuthTarget | undefined) => Promise<import("./account").AccountInfo | null>;
...
export declare const getWorkflowClient: () => import("./workflow_client").WorkflowClient;
