...
export { ACTIVATION_DEFAULT_RTCP_PORT, ACTIVATION_DEVICE_NAME, ACTIVATION_DOCUMENT_VALIDITY_SECONDS, ACTIVATION_LOCK_FILE_NAME, ACTIVATION_MIN_PASSWORD_LENGTH, ACTIVATION_NET_ID, ActivationError, activateOfflineZone, buildActivationDnsRecords, checkOfflineActivation, generateProvisionKeyPair, hashAdminPassword, inspectActivationRoot, validateAdminPassword, validateOwnerName, validatePublicIp, validateRtcpPort, validateZoneDomain, ZONE_DNS_RECORDS_FILE_NAME, ZONE_DOCUMENT_JWT_FILE_NAME, } from './provision_activate';
export type { ActivationDnsRecord, ActivationErrorDetails, ActivationFileEntry, ActivationFileRole, ActivationLockInfo, ActivationLockStage, ActivationProblem, ActivationState, ActivationStatus, CommittedActivationFile, ObservedActivationFile, OfflineActivationCheckOptions, OfflineActivationOptions, OfflineActivationPrecheck, OfflineActivationResult, OwnerKeyBackupTarget, ProvisionKeyPair, } from './provision_activate';
