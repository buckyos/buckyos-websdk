import { a5 as getDefaultExportFromCjs, a6 as commonjsGlobal } from "./ndm_proxy-4a4b9565.mjs";
...
const DetailedError$1 = DetailedError;
var isEnabled = false;
...
var BaseUpload = /* @__PURE__ */ function() {
  ...
  return _createClass$6(BaseUpload2, [{
    ...
    value: function _emitHttpError(req, res, message, causingErr) {
      this._emitError(new DetailedError$1(message, causingErr, req, res));
    }
  }, {
    key: "_emitError",
    ...
    value: function terminate(url) {
      ...
      return sendRequest(req, null, options).then(function(res) {
        ...
        throw new DetailedError$1("tus: unexpected response while terminating upload", null, req, res);
      })["catch"](function(err) {
        if (!(err instanceof DetailedError$1)) {
          err = new DetailedError$1("tus: failed to terminate upload", err, req, null);
        }
...
export {
  ...
  DetailedError$1 as DetailedError,
  Upload,
  canStoreURLs,
  defaultOptions,
  enableDebugLog,
...
//# sourceMappingURL=tus_client-63c79e06.mjs.map
